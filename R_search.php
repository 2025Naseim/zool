                                    ...
                                    if(mysqli_num_rows($query_run) > 0) {
                                        foreach($query_run as $items) {
                                            echo "<tr>
                                                ...
                                                <td>".addSmileIfEmoji($items['li'])."</td>
                        ...
                        foreach($query_run as $items) {
                            echo "<div class='card mobile-card'>
                                    <div class='card-body'>
                                        ...
                                        <p><strong>كبير الأسرة:</strong> ".addSmileIfEmoji($items['li'])."</p>
                                        <p><strong>اسم أم المفقود:</strong> ".addSmileIfEmoji($items['mather'])."</p>
                                        <p><strong>منطقة الميلاد:</strong> ".addSmileIfEmoji($items['place'])."</p>
                                        ...
                                        <p><strong>مكان تواجد المفقود:</strong> ".addSmileIfEmoji($items['relation'])."</p>
