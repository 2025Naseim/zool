...
if(isset($_POST['insert_data'])){
    ...
    $bro = $_POST['bro'];
    $GR = $_POST['GR'];
    $placenow = $_POST['placenow'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];

    $query = "INSERT INTO missing (name,fam,mather,place,vil,bro,GR,placenow,phone,email) 
              VALUES ('$name','$fam','$mather','$place','$vil','$bro','$GR','$placenow','$phone','$email')";
