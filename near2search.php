                                    ...
                                    if(mysqli_num_rows($query_run) > 0) {
                                        foreach($query_run as $items) {
                                            echo "<tr>
                                                ...
                                                <td>".addSmileIfEmoji($items['birthdate'])."</td>
                                                ...
                                                <td>".addSmileIfEmoji($items['adrees'])."</td>
                        ...
                        foreach($query_run as $items) {
                            echo "<div class='card mobile-card'>
                                    <div class='card-body'>
                                        ...
                                        <p><strong>عمر المفقود:</strong> ".addSmileIfEmoji($items['birthdate'])."</p>
                                        ...
                                        <p><strong>الحالة الصحية</strong> ".addSmileIfEmoji($items['health'])."</p>
                                        <p><strong>اسم المبلغ:</strong> ".addSmileIfEmoji($items['reporter'])."</p>
                                        <p><strong>العنوان</strong> ".addSmileIfEmoji($items['adrees'])."</p>
